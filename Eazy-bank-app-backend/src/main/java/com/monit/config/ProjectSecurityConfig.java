...
//        http.exceptionHandling(ehc->ehc.authenticationEntryPoint(new CustomBasicAuthenticationEntryPoint())); //It is a global Config
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
        EazyBankUserNamePwdAuthenticationProvider authenticationProvider = new EazyBankUserNamePwdAuthenticationProvider((EazyBankUserDetailsService) userDetailsService, passwordEncoder);
